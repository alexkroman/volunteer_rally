 ...
 *   entirety and paste it here, changing the prefix from theme_ to doune_.
 *   For example:
 *
 *     original: theme_breadcrumb()
 *     theme override: doune_breadcrumb()
 *
 *   where doune is the name of your sub-theme. For example, the
 ...
 */
function doune_jcalendar_view($node) {
 ...
 */
function doune_date_single_day_element($form) {
